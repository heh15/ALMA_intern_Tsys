...
rmtables('uid___A002_Xbe0d4d_X12f5_v1.asdm.sdm.ms.tsys')
os.system('cp -r uid___A002_Xbe0d4d_X12f5.asdm.sdm.ms.tsys\
        uid___A002_Xbe0d4d_X12f5_v1.asdm.sdm.ms.tsys')
tb.open('uid___A002_Xbe0d4d_X12f5_v1.asdm.sdm.ms.tsys', nomodify=False)
nrows = tb.nrows()
