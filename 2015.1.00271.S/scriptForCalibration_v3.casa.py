...
if(mystep in thesteps):
  ...
  if os.path.exists('uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms') == False:
    importasdm('uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm', asis='Antenna Station Receiver Source CalAtmosphere CalWVR CorrelatorMode SBSummary', bdfflags=True, lazy=False, process_caldevice=False)
    if not os.path.exists('uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.flagversions'):
      print('ERROR in importasdm. Output MS is probably not useful. Will stop here.')
      thesteps = []
  if applyonly != True: es.fixForCSV2555('uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms')
...
if(mystep in thesteps):
  ...
  fixsyscaltimes(vis = 'uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms')
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.listobs')
  listobs(vis = 'uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms',
    listfile = 'uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.listobs')
...
if(mystep in thesteps):
  ...
  flagdata(vis = 'uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms',
    mode = 'manual',
    spw = '5~12,17~24',
    autocorr = True,
    flagbackup = False)
  ...
  flagcmd(vis = 'uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms',
    inpmode = 'table',
    useapplied = True,
    action = 'plot',
    plotfile = 'uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.flagcmd.png')
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.wvr') 
  
  os.system('rm -rf uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.wvrgcal') 
  
  mylogfile = casalog.logfile()
  casalog.setlogfile('uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.wvrgcal')
  
  wvrgcal(vis = 'uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms',
    caltable = 'uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.wvr',
    spw = [17, 19, 21, 23],
    toffset = 0,
  ...
  if applyonly != True: aU.plotWVRSolutions(caltable='uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.wvr', spw='17', antenna='DV10',
    yrange=[-199,199],subplot=22, interactive=False,
    figfile='uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.wvr.plots/uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.wvr') 
...
#   os.system('rm -rf uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.tsys') 
#   gencal(vis = 'uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms',
#     caltable = 'uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.tsys',
#     caltype = 'tsys')
  
  # Flagging edge channels
  
  flagdata(vis = 'uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.tsys',
    mode = 'manual',
    spw = '17:0~3;124~127,19:0~3;124~127,21:0~3;124~127,23:0~3;124~127',
    flagbackup = False)
  
  if applyonly != True: aU.plotbandpass(caltable='uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.tsys', overlay='time', 
    ...
    field='', figfile='uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.tsys.plots.overlayTime/uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.tsys') 
  
  
  if applyonly != True: es.checkCalTable('uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.tsys', msName='uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms', interactive=False) 
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.antpos') 
  gencal(vis = 'uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms',
    caltable = 'uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.antpos',
    caltype = 'antpos',
...
if(mystep in thesteps):
  ...
  tsysmap = tsysspwmap(vis = 'uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms', tsystable = 'uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.tsys', tsysChanTol = 1)
  
  
  
  applycal(vis = 'uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms',
    field = '0',
    spw = '17,19,21,23',
    gaintable = ['uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.tsys', 'uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.wvr', 'uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.antpos',
                'uid___A002_Xbe0d4d_X12f5_v3_tsys_WVR.gcal'],
    gainfield = ['0', '', '','0'],
    interp = 'linear,linear',
    spwmap = [tsysmap,[],[],tsysmap],
    calwt = True,
    flagbackup = False)
  ...
  if applyonly != True: es.getCalWeightStats('uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms') 
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split') 
  os.system('rm -rf uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split.flagversions') 
  
  mstransform(vis = 'uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms',
    outputvis = 'uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split',
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split.listobs')
  listobs(vis = 'uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split',
    listfile = 'uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split.listobs')
  
  
  if not os.path.exists('uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split.flagversions/Original.flags'):
    flagmanager(vis = 'uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split',
      mode = 'save',
...
if(mystep in thesteps):
  ...
  flagdata(vis = 'uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split',
    mode = 'shadow',
    flagbackup = False)
...
if(mystep in thesteps):
  ...
  setjy(vis = 'uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split',
    standard = 'manual',
    field = 'J1256-0547',
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split.ap_pre_bandpass') 
  
  gaincal(vis = 'uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split',
    caltable = 'uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split.ap_pre_bandpass',
    field = '0', # J1256-0547
  ...
  if applyonly != True: es.checkCalTable('uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split.ap_pre_bandpass', msName='uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split', interactive=False) 
  
  os.system('rm -rf uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split.bandpass') 
  bandpass(vis = 'uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split',
    caltable = 'uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split.bandpass',
    field = '0', # J1256-0547
    scan = '1,3',
    solint = 'inf',
    combine = 'scan',
    ...
    solnorm = True,
    bandtype = 'B',
    gaintable = 'uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split.ap_pre_bandpass')
  
  if applyonly != True: es.checkCalTable('uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split.bandpass', msName='uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split', interactive=False) 
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split.phase_int') 
  gaincal(vis = 'uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split',
    caltable = 'uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split.phase_int',
    field = '0~1', # J1256-0547,J1504+1029
    solint = 'int',
    refant = 'DV10',
    gaintype = 'G',
    calmode = 'p',
    gaintable = 'uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split.bandpass')
  
  if applyonly != True: es.checkCalTable('uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split.phase_int', msName='uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split', interactive=False) 
  
  os.system('rm -rf uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split.ampli_inf') 
  gaincal(vis = 'uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split',
    caltable = 'uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split.ampli_inf',
    field = '0~1', # J1256-0547,J1504+1029
    solint = 'inf',
    refant = 'DV10',
    gaintype = 'T',
    calmode = 'a',
    gaintable = ['uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split.bandpass', 'uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split.phase_int'])
  
  if applyonly != True: es.checkCalTable('uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split.ampli_inf', msName='uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split', interactive=False) 
  
  os.system('rm -rf uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split.flux_inf') 
  os.system('rm -rf uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split.fluxscale') 
  mylogfile = casalog.logfile()
  casalog.setlogfile('uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split.fluxscale')
  
  fluxscaleDict = fluxscale(vis = 'uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split',
    caltable = 'uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split.ampli_inf',
    fluxtable = 'uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split.flux_inf',
    reference = '0') # J1256-0547
  
  casalog.setlogfile(mylogfile)
  
  if applyonly != True: es.fluxscale2(caltable = 'uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split.ampli_inf', removeOutliers=True, msName='uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms', writeToFile=True, preavg=10000)
  
  os.system('rm -rf uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split.phase_inf') 
  gaincal(vis = 'uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split',
    caltable = 'uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split.phase_inf',
    field = '0~1', # J1256-0547,J1504+1029
    solint = 'inf',
    refant = 'DV10',
    gaintype = 'G',
  ...
  if applyonly != True: es.checkCalTable('uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split.phase_inf', msName='uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split', interactive=False) 
...
if(mystep in thesteps):
  ...
  for i in ['0']: # J1256-0547
    applycal(vis = 'uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split',
      field = str(i),
      gaintable = ['uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split.bandpass', 'uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split.phase_int', 'uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split.flux_inf'],
      gainfield = ['', i, i],
      interp = 'linear,linear',
      calwt = True,
      flagbackup = False)
  ...
  applycal(vis = 'uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split',
    ...
    gaintable = ['uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split.bandpass', 'uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split.phase_inf', 'uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split.flux_inf'],
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split.cal') 
  os.system('rm -rf uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split.cal.flagversions') 
  ...
  mstransform(vis = 'uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split',
    outputvis = 'uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split.cal',
    datacolumn = 'corrected',
...
if(mystep in thesteps):
  ...
  flagmanager(vis = 'uid___A002_Xbe0d4d_X12f5_v3.asdm.sdm.ms.split.cal',
    mode = 'save',
