...
# CALIBRATE_AMPLI: 
# CALIBRATE_ATMOSPHERE: J0914+0245,J091840.8+023047,J1256-0547
# CALIBRATE_BANDPASS: J1256-0547
# CALIBRATE_DIFFGAIN: 
# CALIBRATE_FLUX: J1256-0547
# CALIBRATE_FOCUS: 
# CALIBRATE_PHASE: J0914+0245
# CALIBRATE_POINTING: J0914+0245,J1256-0547
...
if(mystep in thesteps):
  ...
  if os.path.exists('uid___A002_Xd80784_X2dcf.ms') == False:
    importasdm('uid___A002_Xd80784_X2dcf', asis='Antenna Station Receiver Source CalAtmosphere CalWVR CorrelatorMode SBSummary', bdfflags=True, lazy=False, process_caldevice=False)
    if not os.path.exists('uid___A002_Xd80784_X2dcf.ms.flagversions'):
      print('ERROR in importasdm. Output MS is probably not useful. Will stop here.')
      thesteps = []
  if applyonly != True: es.fixForCSV2555('uid___A002_Xd80784_X2dcf.ms')
...
if(mystep in thesteps):
  ...
  fixsyscaltimes(vis = 'uid___A002_Xd80784_X2dcf.ms')
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_Xd80784_X2dcf.ms.listobs')
  listobs(vis = 'uid___A002_Xd80784_X2dcf.ms',
    listfile = 'uid___A002_Xd80784_X2dcf.ms.listobs')
...
if(mystep in thesteps):
  ...
  flagdata(vis = 'uid___A002_Xd80784_X2dcf.ms',
    mode = 'manual',
    spw = '5~12,17~24',
    autocorr = True,
    flagbackup = False)
  ...
  flagcmd(vis = 'uid___A002_Xd80784_X2dcf.ms',
    inpmode = 'table',
    useapplied = True,
    action = 'plot',
    plotfile = 'uid___A002_Xd80784_X2dcf.ms.flagcmd.png')
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_Xd80784_X2dcf.ms.wvr') 
  
  os.system('rm -rf uid___A002_Xd80784_X2dcf.ms.wvrgcal') 
  
  mylogfile = casalog.logfile()
  casalog.setlogfile('uid___A002_Xd80784_X2dcf.ms.wvrgcal')
  
  wvrgcal(vis = 'uid___A002_Xd80784_X2dcf.ms',
    caltable = 'uid___A002_Xd80784_X2dcf.ms.wvr',
    spw = [17, 19, 21, 23],
    toffset = 0,
  ...
  if applyonly != True: aU.plotWVRSolutions(caltable='uid___A002_Xd80784_X2dcf.ms.wvr', spw='17', antenna='DA45',
    yrange=[-199,199],subplot=22, interactive=False,
    figfile='uid___A002_Xd80784_X2dcf.ms.wvr.plots/uid___A002_Xd80784_X2dcf.ms.wvr') 
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_Xd80784_X2dcf.ms.tsys') 
  gencal(vis = 'uid___A002_Xd80784_X2dcf.ms',
    caltable = 'uid___A002_Xd80784_X2dcf.ms.tsys',
    caltype = 'tsys')
  
  # Flagging edge channels
  
  flagdata(vis = 'uid___A002_Xd80784_X2dcf.ms.tsys',
    mode = 'manual',
    spw = '17:0~3;124~127,19:0~3;124~127,21:0~3;124~127,23:0~3;124~127',
    flagbackup = False)
  
  if applyonly != True: aU.plotbandpass(caltable='uid___A002_Xd80784_X2dcf.ms.tsys', overlay='time', 
    ...
    field='', figfile='uid___A002_Xd80784_X2dcf.ms.tsys.plots.overlayTime/uid___A002_Xd80784_X2dcf.ms.tsys') 
  
  
  if applyonly != True: es.checkCalTable('uid___A002_Xd80784_X2dcf.ms.tsys', msName='uid___A002_Xd80784_X2dcf.ms', interactive=False) 
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_Xd80784_X2dcf.ms.antpos') 
  gencal(vis = 'uid___A002_Xd80784_X2dcf.ms',
    caltable = 'uid___A002_Xd80784_X2dcf.ms.antpos',
    caltype = 'antpos',
...
if(mystep in thesteps):
  ...
  tsysmap = tsysspwmap(vis = 'uid___A002_Xd80784_X2dcf.ms', tsystable = 'uid___A002_Xd80784_X2dcf.ms.tsys', tsysChanTol = 1)
  
  
  
  applycal(vis = 'uid___A002_Xd80784_X2dcf.ms',
    field = '0',
    spw = '17,19,21,23',
    gaintable = ['uid___A002_Xd80784_X2dcf.ms.tsys', 'uid___A002_Xd80784_X2dcf.ms.wvr', 'uid___A002_Xd80784_X2dcf.ms.antpos'],
    gainfield = ['0', '', ''],
  ...
  if applyonly != True: es.getCalWeightStats('uid___A002_Xd80784_X2dcf.ms') 
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_Xd80784_X2dcf.ms.split') 
  os.system('rm -rf uid___A002_Xd80784_X2dcf.ms.split.flagversions') 
  
  mstransform(vis = 'uid___A002_Xd80784_X2dcf.ms',
    outputvis = 'uid___A002_Xd80784_X2dcf.ms.split',
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_Xd80784_X2dcf.ms.split.listobs')
  listobs(vis = 'uid___A002_Xd80784_X2dcf.ms.split',
    listfile = 'uid___A002_Xd80784_X2dcf.ms.split.listobs')
  
  
  if not os.path.exists('uid___A002_Xd80784_X2dcf.ms.split.flagversions/Original.flags'):
    flagmanager(vis = 'uid___A002_Xd80784_X2dcf.ms.split',
      mode = 'save',
...
if(mystep in thesteps):
  ...
  flagdata(vis = 'uid___A002_Xd80784_X2dcf.ms.split',
    mode = 'shadow',
    flagbackup = False)
...
if(mystep in thesteps):
  ...
  setjy(vis = 'uid___A002_Xd80784_X2dcf.ms.split',
    standard = 'manual',
    field = 'J1256-0547',
    usescratch = True,
    fluxdensity = [3.17471374135, 0, 0, 0],
    spix = -0.561678688819,
    reffreq = '705.5046875GHz')
  
  # fluxDensityUncertainty = 0.120743258646
  # meanAge = -4.0
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_Xd80784_X2dcf.ms.split.ap_pre_bandpass') 
  
  gaincal(vis = 'uid___A002_Xd80784_X2dcf.ms.split',
    caltable = 'uid___A002_Xd80784_X2dcf.ms.split.ap_pre_bandpass',
    field = '0', # J1256-0547
  ...
  if applyonly != True: es.checkCalTable('uid___A002_Xd80784_X2dcf.ms.split.ap_pre_bandpass', msName='uid___A002_Xd80784_X2dcf.ms.split', interactive=False) 
  
  os.system('rm -rf uid___A002_Xd80784_X2dcf.ms.split.bandpass') 
  bandpass(vis = 'uid___A002_Xd80784_X2dcf.ms.split',
    caltable = 'uid___A002_Xd80784_X2dcf.ms.split.bandpass',
    field = '0', # J1256-0547
    scan = '3',
    solint = 'inf',
    combine = 'scan',
    ...
    solnorm = True,
    bandtype = 'B',
    gaintable = 'uid___A002_Xd80784_X2dcf.ms.split.ap_pre_bandpass')
  
  if applyonly != True: es.checkCalTable('uid___A002_Xd80784_X2dcf.ms.split.bandpass', msName='uid___A002_Xd80784_X2dcf.ms.split', interactive=False) 
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_Xd80784_X2dcf.ms.split.phase_int') 
  gaincal(vis = 'uid___A002_Xd80784_X2dcf.ms.split',
    caltable = 'uid___A002_Xd80784_X2dcf.ms.split.phase_int',
    field = '0~1', # J1256-0547,J0914+0245
    solint = 'int',
    refant = 'DA45',
    gaintype = 'G',
    calmode = 'p',
    gaintable = 'uid___A002_Xd80784_X2dcf.ms.split.bandpass')
  
  if applyonly != True: es.checkCalTable('uid___A002_Xd80784_X2dcf.ms.split.phase_int', msName='uid___A002_Xd80784_X2dcf.ms.split', interactive=False) 
  
  os.system('rm -rf uid___A002_Xd80784_X2dcf.ms.split.ampli_inf') 
  gaincal(vis = 'uid___A002_Xd80784_X2dcf.ms.split',
    caltable = 'uid___A002_Xd80784_X2dcf.ms.split.ampli_inf',
    field = '0~1', # J1256-0547,J0914+0245
    solint = 'inf',
    refant = 'DA45',
    gaintype = 'T',
    calmode = 'a',
    gaintable = ['uid___A002_Xd80784_X2dcf.ms.split.bandpass', 'uid___A002_Xd80784_X2dcf.ms.split.phase_int'])
  
  if applyonly != True: es.checkCalTable('uid___A002_Xd80784_X2dcf.ms.split.ampli_inf', msName='uid___A002_Xd80784_X2dcf.ms.split', interactive=False) 
  
  os.system('rm -rf uid___A002_Xd80784_X2dcf.ms.split.flux_inf') 
  os.system('rm -rf uid___A002_Xd80784_X2dcf.ms.split.fluxscale') 
  mylogfile = casalog.logfile()
  casalog.setlogfile('uid___A002_Xd80784_X2dcf.ms.split.fluxscale')
  
  fluxscaleDict = fluxscale(vis = 'uid___A002_Xd80784_X2dcf.ms.split',
    caltable = 'uid___A002_Xd80784_X2dcf.ms.split.ampli_inf',
    fluxtable = 'uid___A002_Xd80784_X2dcf.ms.split.flux_inf',
    reference = '0') # J1256-0547
  
  casalog.setlogfile(mylogfile)
  
  if applyonly != True: es.fluxscale2(caltable = 'uid___A002_Xd80784_X2dcf.ms.split.ampli_inf', removeOutliers=True, msName='uid___A002_Xd80784_X2dcf.ms', writeToFile=True, preavg=10000)
  
  os.system('rm -rf uid___A002_Xd80784_X2dcf.ms.split.phase_inf') 
  gaincal(vis = 'uid___A002_Xd80784_X2dcf.ms.split',
    caltable = 'uid___A002_Xd80784_X2dcf.ms.split.phase_inf',
    field = '0~1', # J1256-0547,J0914+0245
    solint = 'inf',
    refant = 'DA45',
    gaintype = 'G',
  ...
  if applyonly != True: es.checkCalTable('uid___A002_Xd80784_X2dcf.ms.split.phase_inf', msName='uid___A002_Xd80784_X2dcf.ms.split', interactive=False) 
...
if(mystep in thesteps):
  ...
  for i in ['0']: # J1256-0547
    applycal(vis = 'uid___A002_Xd80784_X2dcf.ms.split',
      field = str(i),
      gaintable = ['uid___A002_Xd80784_X2dcf.ms.split.bandpass', 'uid___A002_Xd80784_X2dcf.ms.split.phase_int', 'uid___A002_Xd80784_X2dcf.ms.split.flux_inf'],
      gainfield = ['', i, i],
      interp = 'linear,linear',
      calwt = True,
      flagbackup = False)
  ...
  applycal(vis = 'uid___A002_Xd80784_X2dcf.ms.split',
    ...
    gaintable = ['uid___A002_Xd80784_X2dcf.ms.split.bandpass', 'uid___A002_Xd80784_X2dcf.ms.split.phase_inf', 'uid___A002_Xd80784_X2dcf.ms.split.flux_inf'],
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_Xd80784_X2dcf.ms.split.cal') 
  os.system('rm -rf uid___A002_Xd80784_X2dcf.ms.split.cal.flagversions') 
  ...
  mstransform(vis = 'uid___A002_Xd80784_X2dcf.ms.split',
    outputvis = 'uid___A002_Xd80784_X2dcf.ms.split.cal',
    datacolumn = 'corrected',
...
if(mystep in thesteps):
  ...
  flagmanager(vis = 'uid___A002_Xd80784_X2dcf.ms.split.cal',
    mode = 'save',
