...
if(mystep in thesteps):
  ...
  if os.path.exists('uid___A002_Xbf792a_X14cc_v3.ms') == False:
    importasdm('uid___A002_Xbf792a_X14cc_v3', asis='Antenna Station Receiver Source CalAtmosphere CalWVR CorrelatorMode SBSummary', bdfflags=True, lazy=False, process_caldevice=False)
    if not os.path.exists('uid___A002_Xbf792a_X14cc_v3.ms.flagversions'):
      print('ERROR in importasdm. Output MS is probably not useful. Will stop here.')
      thesteps = []
  if applyonly != True: es.fixForCSV2555('uid___A002_Xbf792a_X14cc_v3.ms')
...
if(mystep in thesteps):
  ...
  fixsyscaltimes(vis = 'uid___A002_Xbf792a_X14cc_v3.ms')
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_Xbf792a_X14cc_v3.ms.listobs')
  listobs(vis = 'uid___A002_Xbf792a_X14cc_v3.ms',
    listfile = 'uid___A002_Xbf792a_X14cc_v3.ms.listobs')
...
if(mystep in thesteps):
  ...
  flagdata(vis = 'uid___A002_Xbf792a_X14cc_v3.ms',
    mode = 'manual',
    spw = '5~12,17~42',
    autocorr = True,
    flagbackup = False)
  ...
  flagcmd(vis = 'uid___A002_Xbf792a_X14cc_v3.ms',
    inpmode = 'table',
    useapplied = True,
    action = 'plot',
    plotfile = 'uid___A002_Xbf792a_X14cc_v3.ms.flagcmd.png')
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_Xbf792a_X14cc_v3.ms.wvr') 
  
  os.system('rm -rf uid___A002_Xbf792a_X14cc_v3.ms.wvrgcal') 
  ...
  casalog.setlogfile('uid___A002_Xbf792a_X14cc_v3.ms.wvrgcal')
  
  wvrgcal(vis = 'uid___A002_Xbf792a_X14cc_v3.ms',
    caltable = 'uid___A002_Xbf792a_X14cc_v3.ms.wvr',
  ...
  if applyonly != True: aU.plotWVRSolutions(caltable='uid___A002_Xbf792a_X14cc_v3.ms.wvr', spw='23', antenna='DV04',
    yrange=[-199,199],subplot=22, interactive=False,
    figfile='uid___A002_Xbf792a_X14cc_v3.ms.wvr.plots/uid___A002_Xbf792a_X14cc_v3.ms.wvr') 
...
#   os.system('rm -rf uid___A002_Xbf792a_X14cc_v3.ms.tsys') 
#   gencal(vis = 'uid___A002_Xbf792a_X14cc_v3.ms',
#     caltable = 'uid___A002_Xbf792a_X14cc_v3.ms.tsys',
#     caltype = 'tsys')
  
  # Flagging edge channels
  
  flagdata(vis = 'uid___A002_Xbf792a_X14cc_v3.ms.tsys',
    mode = 'manual',
    spw = '17:0~3;124~127,19:0~3;124~127,21:0~3;124~127,23:0~3;124~127',
    flagbackup = False)
  
  if applyonly != True: aU.plotbandpass(caltable='uid___A002_Xbf792a_X14cc_v3.ms.tsys', overlay='time', 
    ...
    field='', figfile='uid___A002_Xbf792a_X14cc_v3.ms.tsys.plots.overlayTime/uid___A002_Xbf792a_X14cc_v3.ms.tsys') 
  
  
  if applyonly != True: es.checkCalTable('uid___A002_Xbf792a_X14cc_v3.ms.tsys', msName='uid___A002_Xbf792a_X14cc_v3.ms', interactive=False) 
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_Xbf792a_X14cc_v3.ms.antpos') 
  gencal(vis = 'uid___A002_Xbf792a_X14cc_v3.ms',
    caltable = 'uid___A002_Xbf792a_X14cc_v3.ms.antpos',
    caltype = 'antpos',
...
if(mystep in thesteps):
  ...
  tsysmap = tsysspwmap(vis = 'uid___A002_Xbf792a_X14cc_v3.ms', tsystable = 'uid___A002_Xbf792a_X14cc_v3.ms.tsys', tsysChanTol = 1)
  
  
  
  applycal(vis = 'uid___A002_Xbf792a_X14cc_v3.ms',
    field = '0',
    spw = '23,25,27,29,31,33,35,37,39,41',
    gaintable = ['uid___A002_Xbf792a_X14cc_v3.ms.tsys', 'uid___A002_Xbf792a_X14cc_v3.ms.wvr', 'uid___A002_Xbf792a_X14cc_v3.ms.antpos', 
		'uid___A002_Xbf792a_X14cc_v3_tsys_WVR.gcal'],
    gainfield = ['0', '', '', '0'],
  ...
  if applyonly != True: es.getCalWeightStats('uid___A002_Xbf792a_X14cc_v3.ms') 
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_Xbf792a_X14cc_v3.ms.split') 
  os.system('rm -rf uid___A002_Xbf792a_X14cc_v3.ms.split.flagversions') 
  
  mstransform(vis = 'uid___A002_Xbf792a_X14cc_v3.ms',
    outputvis = 'uid___A002_Xbf792a_X14cc_v3.ms.split',
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_Xbf792a_X14cc_v3.ms.split.listobs')
  listobs(vis = 'uid___A002_Xbf792a_X14cc_v3.ms.split',
    listfile = 'uid___A002_Xbf792a_X14cc_v3.ms.split.listobs')
  
  
  if not os.path.exists('uid___A002_Xbf792a_X14cc_v3.ms.split.flagversions/Original.flags'):
    flagmanager(vis = 'uid___A002_Xbf792a_X14cc_v3.ms.split',
      mode = 'save',
...
if(mystep in thesteps):
  ...
  flagdata(vis = 'uid___A002_Xbf792a_X14cc_v3.ms.split',
    mode = 'shadow',
    flagbackup = False)
...
if(mystep in thesteps):
  ...
  setjy(vis = 'uid___A002_Xbf792a_X14cc_v3.ms.split',
    standard = 'manual',
    field = 'J1256-0547',
    usescratch = True,
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_Xbf792a_X14cc_v3.ms.split.ap_pre_bandpass') 
  
  gaincal(vis = 'uid___A002_Xbf792a_X14cc_v3.ms.split',
    caltable = 'uid___A002_Xbf792a_X14cc_v3.ms.split.ap_pre_bandpass',
    field = '0', # J1256-0547
  ...
  if applyonly != True: es.checkCalTable('uid___A002_Xbf792a_X14cc_v3.ms.split.ap_pre_bandpass', msName='uid___A002_Xbf792a_X14cc_v3.ms.split', interactive=False) 
  
  os.system('rm -rf uid___A002_Xbf792a_X14cc_v3.ms.split.bandpass') 
  bandpass(vis = 'uid___A002_Xbf792a_X14cc_v3.ms.split',
    caltable = 'uid___A002_Xbf792a_X14cc_v3.ms.split.bandpass',
    field = '0', # J1256-0547
    scan = '3',
    solint = 'inf',
    combine = 'scan',
    ...
    solnorm = True,
    bandtype = 'B',
    gaintable = 'uid___A002_Xbf792a_X14cc_v3.ms.split.ap_pre_bandpass')
  
  if applyonly != True: es.checkCalTable('uid___A002_Xbf792a_X14cc_v3.ms.split.bandpass', msName='uid___A002_Xbf792a_X14cc_v3.ms.split', interactive=False) 
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_Xbf792a_X14cc_v3.ms.split.phase_int') 
  gaincal(vis = 'uid___A002_Xbf792a_X14cc_v3.ms.split',
    caltable = 'uid___A002_Xbf792a_X14cc_v3.ms.split.phase_int',
    field = '0~1', # J1256-0547,J1626-2951
    solint = 'int',
    refant = 'DV04',
    gaintype = 'G',
    calmode = 'p',
    gaintable = 'uid___A002_Xbf792a_X14cc_v3.ms.split.bandpass')
  
  if applyonly != True: es.checkCalTable('uid___A002_Xbf792a_X14cc_v3.ms.split.phase_int', msName='uid___A002_Xbf792a_X14cc_v3.ms.split', interactive=False) 
  
  os.system('rm -rf uid___A002_Xbf792a_X14cc_v3.ms.split.ampli_inf') 
  gaincal(vis = 'uid___A002_Xbf792a_X14cc_v3.ms.split',
    caltable = 'uid___A002_Xbf792a_X14cc_v3.ms.split.ampli_inf',
    field = '0~1', # J1256-0547,J1626-2951
    solint = 'inf',
    refant = 'DV04',
    gaintype = 'T',
    calmode = 'a',
    gaintable = ['uid___A002_Xbf792a_X14cc_v3.ms.split.bandpass', 'uid___A002_Xbf792a_X14cc_v3.ms.split.phase_int'])
  
  if applyonly != True: es.checkCalTable('uid___A002_Xbf792a_X14cc_v3.ms.split.ampli_inf', msName='uid___A002_Xbf792a_X14cc_v3.ms.split', interactive=False) 
  
  os.system('rm -rf uid___A002_Xbf792a_X14cc_v3.ms.split.flux_inf') 
  os.system('rm -rf uid___A002_Xbf792a_X14cc_v3.ms.split.fluxscale') 
  mylogfile = casalog.logfile()
  casalog.setlogfile('uid___A002_Xbf792a_X14cc_v3.ms.split.fluxscale')
  
  fluxscaleDict = fluxscale(vis = 'uid___A002_Xbf792a_X14cc_v3.ms.split',
    caltable = 'uid___A002_Xbf792a_X14cc_v3.ms.split.ampli_inf',
    fluxtable = 'uid___A002_Xbf792a_X14cc_v3.ms.split.flux_inf',
    reference = '0') # J1256-0547
  
  casalog.setlogfile(mylogfile)
  
  if applyonly != True: es.fluxscale2(caltable = 'uid___A002_Xbf792a_X14cc_v3.ms.split.ampli_inf', removeOutliers=True, msName='uid___A002_Xbf792a_X14cc_v3.ms', writeToFile=True, preavg=10000)
  
  os.system('rm -rf uid___A002_Xbf792a_X14cc_v3.ms.split.phase_inf') 
  gaincal(vis = 'uid___A002_Xbf792a_X14cc_v3.ms.split',
    caltable = 'uid___A002_Xbf792a_X14cc_v3.ms.split.phase_inf',
    field = '0~1', # J1256-0547,J1626-2951
    solint = 'inf',
    refant = 'DV04',
    gaintype = 'G',
  ...
  if applyonly != True: es.checkCalTable('uid___A002_Xbf792a_X14cc_v3.ms.split.phase_inf', msName='uid___A002_Xbf792a_X14cc_v3.ms.split', interactive=False) 
...
if(mystep in thesteps):
  ...
  for i in ['0']: # J1256-0547
    applycal(vis = 'uid___A002_Xbf792a_X14cc_v3.ms.split',
      field = str(i),
      gaintable = ['uid___A002_Xbf792a_X14cc_v3.ms.split.bandpass', 'uid___A002_Xbf792a_X14cc_v3.ms.split.phase_int', 'uid___A002_Xbf792a_X14cc_v3.ms.split.flux_inf'],
      gainfield = ['', i, i],
      interp = 'linear,linear',
      calwt = True,
      flagbackup = False)
  ...
  applycal(vis = 'uid___A002_Xbf792a_X14cc_v3.ms.split',
    ...
    gaintable = ['uid___A002_Xbf792a_X14cc_v3.ms.split.bandpass', 'uid___A002_Xbf792a_X14cc_v3.ms.split.phase_inf', 'uid___A002_Xbf792a_X14cc_v3.ms.split.flux_inf'],
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_Xbf792a_X14cc_v3.ms.split.cal') 
  os.system('rm -rf uid___A002_Xbf792a_X14cc_v3.ms.split.cal.flagversions') 
  ...
  mstransform(vis = 'uid___A002_Xbf792a_X14cc_v3.ms.split',
    outputvis = 'uid___A002_Xbf792a_X14cc_v3.ms.split.cal',
    datacolumn = 'corrected',
...
if(mystep in thesteps):
  ...
  flagmanager(vis = 'uid___A002_Xbf792a_X14cc_v3.ms.split.cal',
    mode = 'save',
