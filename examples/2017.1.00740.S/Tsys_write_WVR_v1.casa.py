...
vis = 'uid___A002_Xd80784_X26be.ms'
vis = 'uid___A002_Xd80784_X2dcf.ms' 
...
scan_ATM = np.array([2, 5, 8, 10, 12, 14, 17])
scan_phase = np.array([6, 11, 15, 19])
scan_checksource = np.array([7, 16])
scan_bpass = np.array([3])
scan_sci = np.array([9, 13, 18])
