...
filename_gain = 'WVR_partextrap_gaintable_chanWVR0_avgtime10.pkl' 
...
vis_tsys_out = vis.replace('.ms', '_partextrap.ms.tsys')
...
vis_tsys_gain = vis.replace('.ms', '_partextrap_tsys_WVR.gcal') 
